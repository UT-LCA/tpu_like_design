...
../../8x8int8.4x4fp16.organized.combined.modes.no_eltwise_mode.no_preload.v
}
...
link
ungroup -all -flatten 
uplevel #0 { report_timing -path full -delay max -nworst 1 -max_paths 1 -significant_digits 2 -sort_by group } >> Report.8x8int8.4x4fp16.timing.max.modes.no_eltwise_mode.no_preload.txt
uplevel #0 { report_area -hierarchy } >> Report.8x8int8.4x4fp16.area.modes.no_eltwise_mode.no_preload.txt
exit
