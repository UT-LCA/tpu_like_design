...
reg [2:0] temp3_address_a;
reg [2:0] temp3_address_b;
...
defparam temp3.widthad_a = 3;
defparam temp3.widthad_b = 3;
defparam temp3.width_be_a = 1;
defparam temp3.width_be_b = 1;
defparam temp3.numwords_a = 8;
defparam temp3.numwords_b = 8;
...
always @(*)
begin
	temp3_address_a = memory_controller_address_a [3-1+2:2] & {3{select_temp3_a}};
...
always @(*)
begin
	temp3_address_b = memory_controller_address_b [3-1+2:2] & {3{select_temp3_b}};
...
always @(*) begin
	...
	/*   %exitcond9 = icmp eq i64 %6, 8*/
		main_reduceinnerloop_bodyreduction_dim1_exitcond9 = (main_reduceinnerloop_bodyreduction_dim1_6 == 64'd8);
end
always @(posedge clk) begin
	/* main: %reduce.inner.loop_body.reduction_dim.1*/
	/*   %exitcond9 = icmp eq i64 %6, 8*/
...
always @(*) begin
	...
	/*   %exitcond6 = icmp eq i64 %89, 8*/
		main_expfexit_exitcond6 = (main_expfexit_89 == 64'd8);
end
always @(posedge clk) begin
	/* main: %expf.exit*/
	/*   %exitcond6 = icmp eq i64 %89, 8*/
...
always @(*) begin
	...
	/*   %exitcond = icmp eq i64 %93, 8*/
		main_reduce1innerloop_bodyreduction_dim1_exitcond = (main_reduce1innerloop_bodyreduction_dim1_93 == 64'd8);
end
always @(posedge clk) begin
	/* main: %reduce.1.inner.loop_body.reduction_dim.1*/
	/*   %exitcond = icmp eq i64 %93, 8*/
...
always @(*) begin
	...
	/*   %exitcond1 = icmp eq i64 %96, 8*/
		main_fusionloop_bodydim0_exitcond1 = (main_fusionloop_bodydim0_96 == 64'd8);
end
always @(posedge clk) begin
	/* main: %fusion.loop_body.dim.0*/
	/*   %exitcond1 = icmp eq i64 %96, 8*/
