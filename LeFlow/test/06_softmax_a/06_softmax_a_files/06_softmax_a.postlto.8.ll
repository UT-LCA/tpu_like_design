; ModuleID = '06_softmax_a.postlto.8.bc'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux_gnu"

%union.ieee_float_shape_type = type { float }

@temp3 = internal global [8 x float] zeroinitializer, align 8
@temp1 = internal unnamed_addr global [1 x [8 x float]] zeroinitializer, align 8
...
reduce.inner.loop_body.reduction_dim.1:           ; preds = %reduce.inner.loop_body.reduction_dim.1, %reduce.inner.loop_body.reduction_dim.1.lr.ph
  ...
  %exitcond5 = icmp eq i64 %invar.inc1, 8
  br i1 %exitcond5, label %fusion.1.loop_body.dim.1.lr.ph, label %reduce.inner.loop_body.reduction_dim.1, !llvm.loop !1
...
fusion.1.loop_body.dim.1:                         ; preds = %fusion.1.loop_body.dim.1, %fusion.1.loop_body.dim.1.lr.ph
  ...
  %7 = getelementptr inbounds [1 x [8 x float]]* @param0, i64 0, i64 0, i64 %fusion.1.indvar.dim.18
  %8 = load volatile float* %7, align 4
  %9 = fsub float %8, %.lcssa1
  %10 = call float @expf(float %9)
  %11 = getelementptr inbounds [1 x [8 x float]]* @temp1, i64 0, i64 0, i64 %fusion.1.indvar.dim.18
  store float %10, float* %11, align 4
  %invar.inc3 = add nuw nsw i64 %fusion.1.indvar.dim.18, 1
  %exitcond4 = icmp eq i64 %invar.inc3, 8
...
reduce.1.inner.loop_body.reduction_dim.1:         ; preds = %reduce.1.inner.loop_body.reduction_dim.1, %fusion.1.loop_body.dim.1
  ...
  %13 = getelementptr inbounds [1 x [8 x float]]* @temp1, i64 0, i64 0, i64 %reduce.1.inner.indvar.reduction_dim.14
  %14 = load float* %13, align 4
  %15 = fadd float %12, %14
  %invar.inc6 = add nuw nsw i64 %reduce.1.inner.indvar.reduction_dim.14, 1
  %exitcond3 = icmp eq i64 %invar.inc6, 8
  br i1 %exitcond3, label %fusion.loop_body.dim.0.lr.ph, label %reduce.1.inner.loop_body.reduction_dim.1, !llvm.loop !4
...
fusion.loop_body.dim.0:                           ; preds = %fusion.loop_body.dim.0, %fusion.loop_body.dim.0.lr.ph
  ...
  %16 = getelementptr inbounds [1 x [8 x float]]* @temp1, i64 0, i64 0, i64 %fusion.indvar.dim.02
  %17 = load float* %16, align 4
  %18 = fdiv float %17, %.lcssa
  %19 = getelementptr inbounds [8 x float]* @temp3, i64 0, i64 %fusion.indvar.dim.02
  store volatile float %18, float* %19, align 4
  %invar.inc12 = add nuw nsw i64 %fusion.indvar.dim.02, 1
  %exitcond = icmp eq i64 %invar.inc12, 8
...
fusion.loop_exit.dim.0:                           ; preds = %fusion.loop_body.dim.0
  %leflow_retval = load volatile float* getelementptr inbounds ([8 x float]* @temp3, i64 0, i64 0), align 4
