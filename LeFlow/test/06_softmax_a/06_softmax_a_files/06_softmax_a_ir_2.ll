...
reduce.inner.loop_body.reduction_dim.1:           ; preds = %reduce.inner.loop_header.reduction_dim.1
  %7 = getelementptr inbounds [1 x [8 x float]]* %bitcast, i64 0, i64 0, i64 %reduce.inner.indvar.reduction_dim.1
...
fusion.1.loop_body.dim.1:                         ; preds = %fusion.1.loop_header.dim.1
  %17 = getelementptr inbounds [1 x [8 x float]]* %bitcast, i64 0, i64 0, i64 %fusion.1.indvar.dim.1
  %18 = load float* %17
  %19 = getelementptr inbounds [1 x float]* %reduce, i64 0, i64 0
  %20 = load float* %19
  %21 = fsub float %18, %20
  %22 = call float @llvm.exp.f32(float %21)
  %23 = getelementptr inbounds [1 x [8 x float]]* %fusion.1, i64 0, i64 0, i64 %fusion.1.indvar.dim.1
...
fusion.1.loop_exit.dim.0:                         ; preds = %fusion.1.loop_header.dim.0
  ...
  %26 = getelementptr inbounds i8* %25, i64 32
...
reduce.1.inner.loop_body.reduction_dim.1:         ; preds = %reduce.1.inner.loop_header.reduction_dim.1
  %30 = getelementptr inbounds [1 x [8 x float]]* %fusion.1, i64 0, i64 0, i64 %reduce.1.inner.indvar.reduction_dim.1
...
fusion.loop_body.dim.0:                           ; preds = %fusion.loop_header.dim.0
  ...
  %41 = udiv i64 %40, 8
  %42 = getelementptr inbounds [1 x [8 x float]]* %fusion.1, i64 0, i64 0, i64 %40
  %43 = load float* %42
  %44 = getelementptr inbounds [1 x float]* %reduce.1, i64 0, i64 0
  %45 = load float* %44
  %46 = fdiv float %43, %45
  %47 = getelementptr inbounds [8 x float]* %fusion, i64 0, i64 %fusion.indvar.dim.0
