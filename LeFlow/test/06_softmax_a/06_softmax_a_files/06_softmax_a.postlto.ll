; ModuleID = '06_softmax_a.postlto.bc'
...
expf.exit:                                        ; preds = %87, %84, %70, %54, %22, %20, %18, %14
  ...
  %92 = getelementptr inbounds [1 x [8 x float]]* @temp1, i64 0, i64 0, i64 %fusion.1.indvar.dim.18
...
reduce.1.inner.loop_body.reduction_dim.1:         ; preds = %reduce.1.inner.loop_body.reduction_dim.1, %expf.exit
  ...
  %94 = getelementptr inbounds [1 x [8 x float]]* @temp1, i64 0, i64 0, i64 %reduce.1.inner.indvar.reduction_dim.14
...
fusion.loop_body.dim.0:                           ; preds = %fusion.loop_body.dim.0, %fusion.loop_body.dim.0.preheader
  ...
  %97 = getelementptr inbounds [1 x [8 x float]]* @temp1, i64 0, i64 0, i64 %fusion.indvar.dim.02
  %98 = load float* %97, align 4
  %99 = fdiv float %98, %.lcssa
  %100 = getelementptr inbounds [8 x float]* @temp3, i64 0, i64 %fusion.indvar.dim.02
...
fusion.loop_exit.dim.0:                           ; preds = %fusion.loop_body.dim.0
  %leflow_retval = load volatile float* getelementptr inbounds ([8 x float]* @temp3, i64 0, i64 0), align 8
