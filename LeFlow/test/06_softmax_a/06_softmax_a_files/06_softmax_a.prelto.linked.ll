; ModuleID = '06_softmax_a.prelto.linked.bc'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux_gnu"

@temp3 = global [8 x float] zeroinitializer, align 8
@temp2 = global float 0.000000e+00, align 8
@temp1 = global [1 x [8 x float]] zeroinitializer, align 8
...
reduce.inner.loop_body.reduction_dim.1:           ; preds = %reduce.inner.loop_body.reduction_dim.1, %reduce.inner.loop_body.reduction_dim.1.lr.ph
  ...
  %1 = getelementptr inbounds [1 x [8 x float]]* @param0, i64 0, i64 0, i64 %reduce.inner.indvar.reduction_dim.112
  ...
  %7 = icmp ugt i64 %invar.inc1, 7
  br i1 %7, label %fusion.1.loop_body.dim.1.lr.ph, label %reduce.inner.loop_body.reduction_dim.1, !llvm.loop !0
...
fusion.1.loop_body.dim.1:                         ; preds = %fusion.1.loop_body.dim.1, %fusion.1.loop_body.dim.1.lr.ph
  ...
  %8 = getelementptr inbounds [1 x [8 x float]]* @param0, i64 0, i64 0, i64 %fusion.1.indvar.dim.18
  %9 = load volatile float* %8, align 4
  %10 = load float* @temp0, align 4
  %11 = fsub float %9, %10
  %12 = call float @llvm.exp.f32(float %11)
  %13 = getelementptr inbounds [1 x [8 x float]]* @temp1, i64 0, i64 0, i64 %fusion.1.indvar.dim.18
  store float %12, float* %13, align 4
  %invar.inc3 = add nuw nsw i64 %fusion.1.indvar.dim.18, 1
  %14 = icmp ugt i64 %invar.inc3, 7
  br i1 %14, label %reduce.1.inner.loop_body.reduction_dim.1.lr.ph, label %fusion.1.loop_body.dim.1, !llvm.loop !2
...
reduce.1.inner.loop_body.reduction_dim.1:         ; preds = %reduce.1.inner.loop_body.reduction_dim.1, %reduce.1.inner.loop_body.reduction_dim.1.lr.ph
  ...
  %16 = getelementptr inbounds [1 x [8 x float]]* @temp1, i64 0, i64 0, i64 %reduce.1.inner.indvar.reduction_dim.14
  %17 = load float* %16, align 4
  %18 = fadd float %15, %17
  %invar.inc6 = add nuw nsw i64 %reduce.1.inner.indvar.reduction_dim.14, 1
  %19 = icmp ugt i64 %invar.inc6, 7
  br i1 %19, label %fusion.loop_body.dim.0.lr.ph, label %reduce.1.inner.loop_body.reduction_dim.1, !llvm.loop !3
...
fusion.loop_body.dim.0:                           ; preds = %fusion.loop_body.dim.0, %fusion.loop_body.dim.0.lr.ph
  ...
  %20 = getelementptr inbounds [1 x [8 x float]]* @temp1, i64 0, i64 0, i64 %fusion.indvar.dim.02
  %21 = load float* %20, align 4
  %22 = load float* @temp2, align 4
  %23 = fdiv float %21, %22
  %24 = getelementptr inbounds [8 x float]* @temp3, i64 0, i64 %fusion.indvar.dim.02
  store volatile float %23, float* %24, align 4
  %invar.inc12 = add nuw nsw i64 %fusion.indvar.dim.02, 1
  %25 = icmp ugt i64 %invar.inc12, 7
  br i1 %25, label %fusion.loop_exit.dim.0, label %fusion.loop_body.dim.0, !llvm.loop !4

fusion.loop_exit.dim.0:                           ; preds = %fusion.loop_body.dim.0
  %leflow_gep = getelementptr inbounds [8 x float]* @temp3, i64 0, i64 0
