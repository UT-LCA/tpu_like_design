; ModuleID = '05_dense_b.prelto.6.bc'
...
dot.loop_exit.reduction:                          ; preds = %dot.loop_exit.reduction, %dot.loop_body.rhs.1.lr.ph
  ...
  %.phi.trans.insert = getelementptr inbounds [1 x [64 x float]]* @param0, i64 0, i64 0, i64 %dot.indvar.rhs.16
  ...
  %2 = getelementptr inbounds [1 x [64 x float]]* @temp0, i64 0, i64 0, i64 %dot.indvar.rhs.16
  store float %1, float* %2, align 4
  %invar.inc1 = add nuw nsw i64 %dot.indvar.rhs.16, 1
  %exitcond1 = icmp eq i64 %invar.inc1, 64
  br i1 %exitcond1, label %fusion.loop_body.dim.0, label %dot.loop_exit.reduction, !llvm.loop !0
...
fusion.loop_body.dim.0:                           ; preds = %fusion.loop_body.dim.0, %dot.loop_exit.reduction
  ...
  %3 = getelementptr inbounds [64 x float]* @param1, i64 0, i64 %fusion.indvar.dim.02
  %4 = load volatile float* %3, align 4
  %5 = getelementptr inbounds [1 x [64 x float]]* @temp0, i64 0, i64 0, i64 %fusion.indvar.dim.02
  %6 = load float* %5, align 4
  %7 = fadd float %4, %6
  %8 = getelementptr inbounds [64 x float]* @temp1, i64 0, i64 %fusion.indvar.dim.02
  store volatile float %7, float* %8, align 4
  %invar.inc3 = add nuw nsw i64 %fusion.indvar.dim.02, 1
  %exitcond = icmp eq i64 %invar.inc3, 64
  br i1 %exitcond, label %fusion.loop_exit.dim.0, label %fusion.loop_body.dim.0, !llvm.loop !2

fusion.loop_exit.dim.0:                           ; preds = %fusion.loop_body.dim.0
  %leflow_retval = load volatile float* getelementptr inbounds ([64 x float]* @temp1, i64 0, i64 0), align 4
