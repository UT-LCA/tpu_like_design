...
@temp1 = global [64 x float] zeroinitializer, align 8
@temp0 = global [1 x [64 x float]] zeroinitializer, align 8
@param2 = global float zeroinitializer, align 8
...
dot.loop_exit.reduction:                          ; preds = %dot.loop_exit.reduction, %dot.loop_body.rhs.1.lr.ph
  ...
  %3 = icmp ugt i64 %invar.inc1, 63
  br i1 %3, label %fusion.loop_body.dim.0.lr.ph, label %dot.loop_exit.reduction, !llvm.loop !3
...
fusion.loop_body.dim.0:                           ; preds = %fusion.loop_body.dim.0, %fusion.loop_body.dim.0.lr.ph
  ...
  %4 = getelementptr inbounds [64 x float]* @param1, i64 0, i64 %fusion.indvar.dim.02
  %5 = load volatile float* %4, align 4
  %6 = getelementptr inbounds [1 x [64 x float]]* @temp0, i64 0, i64 0, i64 %fusion.indvar.dim.02
  %7 = load float* %6, align 4
  %8 = fadd float %5, %7
  %9 = getelementptr inbounds [64 x float]* @temp1, i64 0, i64 %fusion.indvar.dim.02
  store volatile float %8, float* %9, align 4
  %invar.inc3 = add nuw nsw i64 %fusion.indvar.dim.02, 1
  %10 = icmp ugt i64 %invar.inc3, 63
  br i1 %10, label %fusion.loop_exit.dim.0, label %fusion.loop_body.dim.0, !llvm.loop !5

fusion.loop_exit.dim.0:                           ; preds = %fusion.loop_body.dim.0
  %leflow_gep = getelementptr inbounds [64 x float]* @temp1, i64 0, i64 0
