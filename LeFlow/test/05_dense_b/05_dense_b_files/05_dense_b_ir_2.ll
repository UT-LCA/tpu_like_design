...
entry:
  ...
  %arg1.untyped = load i8** %0, !dereferenceable !0, !align !1
  %1 = bitcast i8* %arg1.untyped to [1 x [64 x float]]*
  %2 = getelementptr inbounds i8** %params, i64 0
  %arg0.untyped = load i8** %2, !dereferenceable !2, !align !1
  %3 = bitcast i8* %arg0.untyped to [1 x [1 x float]]*
  %4 = getelementptr inbounds i8** %params, i64 2
  %arg2.untyped = load i8** %4, !dereferenceable !0, !align !1
  %5 = bitcast i8* %arg2.untyped to [64 x float]*
  %6 = getelementptr inbounds i8** %temps, i64 5
  %7 = load i8** %6, !dereferenceable !0, !align !1
  %dot = bitcast i8* %7 to [1 x [64 x float]]*
...
dot.loop_header.rhs.1:                            ; preds = %dot.loop_exit.reduction, %dot.loop_body.lhs.0
  ...
  %9 = icmp uge i64 %dot.indvar.rhs.1, 64
...
dot.loop_body.reduction:                          ; preds = %dot.loop_header.reduction
  %11 = getelementptr inbounds [1 x [1 x float]]* %3, i64 0, i64 0, i64 0
  %12 = load float* %11
  %13 = getelementptr inbounds [1 x [64 x float]]* %1, i64 0, i64 0, i64 %dot.indvar.rhs.1
  %14 = load float* %13
...
dot.loop_exit.reduction:                          ; preds = %dot.loop_header.reduction
  ...
  %19 = getelementptr inbounds [1 x [64 x float]]* %dot, i64 0, i64 0, i64 %dot.indvar.rhs.1
...
dot.loop_exit.lhs.0:                              ; preds = %dot.loop_header.lhs.0
  %20 = getelementptr inbounds i8** %temps, i64 0
  %21 = load i8** %20, !dereferenceable !0, !align !1
  %fusion = bitcast i8* %21 to [64 x float]*
...
fusion.loop_header.dim.0:                         ; preds = %fusion.loop_body.dim.0, %dot.loop_exit.lhs.0
  ...
  %22 = icmp uge i64 %fusion.indvar.dim.0, 64
  br i1 %22, label %fusion.loop_exit.dim.0, label %fusion.loop_body.dim.0

fusion.loop_body.dim.0:                           ; preds = %fusion.loop_header.dim.0
  %23 = getelementptr inbounds [64 x float]* %5, i64 0, i64 %fusion.indvar.dim.0
  %24 = load float* %23
  %25 = mul nuw nsw i64 %fusion.indvar.dim.0, 1
  %26 = add nuw nsw i64 0, %25
  %27 = udiv i64 %26, 64
  %28 = getelementptr inbounds [1 x [64 x float]]* %dot, i64 0, i64 0, i64 %26
  %29 = load float* %28
  %30 = fadd float %24, %29
  %31 = getelementptr inbounds [64 x float]* %fusion, i64 0, i64 %fusion.indvar.dim.0
...
fusion.loop_exit.dim.0:                           ; preds = %fusion.loop_header.dim.0
  ...
  %32 = getelementptr inbounds [1 x i8*]* %tuple.1, i64 0, i64 0
  %33 = bitcast [64 x float]* %fusion to i8*
  store i8* %33, i8** %32
  ret void
}
