; ModuleID = '04_dense_a_files/04_dense_a_ir_4.bc'
...
dot.loop_exit.reduction:                          ; preds = %dot.loop_exit.reduction, %dot.loop_body.rhs.1.lr.ph
  ...
  %.phi.trans.insert = getelementptr inbounds [1 x [8 x float]]* %1, i64 0, i64 0, i64 %dot.indvar.rhs.16
  ...
  %8 = getelementptr inbounds [1 x [8 x float]]* %dot, i64 0, i64 0, i64 %dot.indvar.rhs.16
...
fusion.loop_body.dim.0:                           ; preds = %fusion.loop_body.dim.0, %fusion.loop_body.dim.0.lr.ph
  ...
  %11 = getelementptr inbounds [8 x float]* %3, i64 0, i64 %fusion.indvar.dim.02
  %12 = load float* %11, align 4
  %13 = getelementptr inbounds [1 x [8 x float]]* %dot, i64 0, i64 0, i64 %fusion.indvar.dim.02
  %14 = load float* %13, align 4
  %15 = fadd float %12, %14
  %16 = getelementptr inbounds [8 x float]* %fusion, i64 0, i64 %fusion.indvar.dim.02
