...
dot.loop_body.reduction:                          ; preds = %dot.loop_header.reduction
  ...
  %12 = load float* %11
  %13 = getelementptr inbounds [1 x [8 x float]]* %1, i64 0, i64 0, i64 %dot.indvar.rhs.1
  %14 = load float* %13
...
dot.loop_exit.reduction:                          ; preds = %dot.loop_header.reduction
  ...
  %19 = getelementptr inbounds [1 x [8 x float]]* %dot, i64 0, i64 0, i64 %dot.indvar.rhs.1
...
fusion.loop_body.dim.0:                           ; preds = %fusion.loop_header.dim.0
  %23 = getelementptr inbounds [8 x float]* %5, i64 0, i64 %fusion.indvar.dim.0
  %24 = load float* %23
  %25 = mul nuw nsw i64 %fusion.indvar.dim.0, 1
  %26 = add nuw nsw i64 0, %25
  %27 = udiv i64 %26, 8
  %28 = getelementptr inbounds [1 x [8 x float]]* %dot, i64 0, i64 0, i64 %26
  %29 = load float* %28
  %30 = fadd float %24, %29
  %31 = getelementptr inbounds [8 x float]* %fusion, i64 0, i64 %fusion.indvar.dim.0
