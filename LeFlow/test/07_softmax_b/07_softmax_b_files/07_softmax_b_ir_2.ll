...
entry:
  ...
  %arg0.untyped = load i8** %0, !dereferenceable !1, !align !2
  %1 = bitcast i8* %arg0.untyped to [64 x float]*
  %bitcast = bitcast [64 x float]* %1 to [1 x [64 x float]]*
  %2 = getelementptr inbounds i8** %temps, i64 0
  %3 = load i8** %2, !dereferenceable !1, !align !2
...
reduce.inner.loop_header.reduction_dim.1:         ; preds = %reduce.inner.loop_body.reduction_dim.1, %reduce.loop_body.dim.0
  ...
  %6 = icmp uge i64 %reduce.inner.indvar.reduction_dim.1, 64
...
reduce.inner.loop_body.reduction_dim.1:           ; preds = %reduce.inner.loop_header.reduction_dim.1
  %7 = getelementptr inbounds [1 x [64 x float]]* %bitcast, i64 0, i64 0, i64 %reduce.inner.indvar.reduction_dim.1
  %reduce_function_parameter_0_address_as_i8ptr = bitcast float* %accumulator to i8*
  %8 = getelementptr inbounds i8** %reduce_function_parameter_addresses, i64 0
  ...
  %9 = getelementptr inbounds i8** %reduce_function_parameter_addresses, i64 1
...
reduce.inner.loop_exit.reduction_dim.1:           ; preds = %reduce.inner.loop_header.reduction_dim.1
  %11 = load float* %accumulator
  %12 = getelementptr inbounds [1 x float]* %reduce, i64 0, i64 0
...
reduce.loop_exit.dim.0:                           ; preds = %reduce.loop_header.dim.0
  %13 = getelementptr inbounds i8** %temps, i64 9
  %14 = load i8** %13, !dereferenceable !6, !align !2
  %fusion.1 = bitcast i8* %14 to [1 x [64 x float]]*
...
fusion.1.loop_header.dim.1:                       ; preds = %fusion.1.loop_body.dim.1, %fusion.1.loop_body.dim.0
  ...
  %16 = icmp uge i64 %fusion.1.indvar.dim.1, 64
...
fusion.1.loop_body.dim.1:                         ; preds = %fusion.1.loop_header.dim.1
  %17 = getelementptr inbounds [1 x [64 x float]]* %bitcast, i64 0, i64 0, i64 %fusion.1.indvar.dim.1
  %18 = load float* %17
  %19 = getelementptr inbounds [1 x float]* %reduce, i64 0, i64 0
  %20 = load float* %19
  %21 = fsub float %18, %20
  %22 = call float @llvm.exp.f32(float %21)
  %23 = getelementptr inbounds [1 x [64 x float]]* %fusion.1, i64 0, i64 0, i64 %fusion.1.indvar.dim.1
...
fusion.1.loop_exit.dim.0:                         ; preds = %fusion.1.loop_header.dim.0
  %24 = getelementptr inbounds i8** %temps, i64 9
  %25 = load i8** %24, !dereferenceable !6, !align !2
...
reduce.1.inner.loop_header.reduction_dim.1:       ; preds = %reduce.1.inner.loop_body.reduction_dim.1, %reduce.1.loop_body.dim.0
  ...
  %29 = icmp uge i64 %reduce.1.inner.indvar.reduction_dim.1, 64
...
reduce.1.inner.loop_body.reduction_dim.1:         ; preds = %reduce.1.inner.loop_header.reduction_dim.1
  %30 = getelementptr inbounds [1 x [64 x float]]* %fusion.1, i64 0, i64 0, i64 %reduce.1.inner.indvar.reduction_dim.1
  %reduce_function_parameter_0_address_as_i8ptr9 = bitcast float* %accumulator5 to i8*
  %31 = getelementptr inbounds i8** %reduce_function_parameter_addresses8, i64 0
  ...
  %32 = getelementptr inbounds i8** %reduce_function_parameter_addresses8, i64 1
  ...
  %reduce_function_return_value11 = load float* %reduce_function_return_value_address7
...
reduce.1.inner.loop_exit.reduction_dim.1:         ; preds = %reduce.1.inner.loop_header.reduction_dim.1
  %34 = load float* %accumulator5
  %35 = getelementptr inbounds [1 x float]* %reduce.1, i64 0, i64 0
...
reduce.1.loop_exit.dim.0:                         ; preds = %reduce.1.loop_header.dim.0
  %36 = getelementptr inbounds i8** %temps, i64 0
  %37 = load i8** %36, !dereferenceable !1, !align !2
  %fusion = bitcast i8* %37 to [64 x float]*
...
fusion.loop_header.dim.0:                         ; preds = %fusion.loop_body.dim.0, %reduce.1.loop_exit.dim.0
  ...
  %38 = icmp uge i64 %fusion.indvar.dim.0, 64
...
fusion.loop_body.dim.0:                           ; preds = %fusion.loop_header.dim.0
  ...
  %41 = udiv i64 %40, 64
  %42 = getelementptr inbounds [1 x [64 x float]]* %fusion.1, i64 0, i64 0, i64 %40
  %43 = load float* %42
  %44 = getelementptr inbounds [1 x float]* %reduce.1, i64 0, i64 0
  %45 = load float* %44
  %46 = fdiv float %43, %45
  %47 = getelementptr inbounds [64 x float]* %fusion, i64 0, i64 %fusion.indvar.dim.0
...
fusion.loop_exit.dim.0:                           ; preds = %fusion.loop_header.dim.0
  ...
  %48 = getelementptr inbounds [1 x i8*]* %tuple.1, i64 0, i64 0
  %49 = bitcast [64 x float]* %fusion to i8*
  store i8* %49, i8** %48
  ret void
}
...
!9 = metadata !{metadata !9, metadata !4}
!10 = metadata !{metadata !10, metadata !4}
!11 = metadata !{metadata !11, metadata !4}
