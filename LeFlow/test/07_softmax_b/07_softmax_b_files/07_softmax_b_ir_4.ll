...
fusion.1.loop_body.dim.1:                         ; preds = %fusion.1.loop_body.dim.1, %fusion.1.loop_body.dim.1.lr.ph
  ...
  %17 = getelementptr inbounds [1 x [64 x float]]* %fusion.1, i64 0, i64 0, i64 %fusion.1.indvar.dim.18
...
reduce.1.inner.loop_body.reduction_dim.1.lr.ph:   ; preds = %fusion.1.loop_body.dim.1
  %19 = getelementptr inbounds i8* %11, i64 256
...
reduce.1.inner.loop_body.reduction_dim.1:         ; preds = %reduce.1.inner.loop_body.reduction_dim.1, %reduce.1.inner.loop_body.reduction_dim.1.lr.ph
  ...
  %21 = getelementptr inbounds [1 x [64 x float]]* %fusion.1, i64 0, i64 0, i64 %reduce.1.inner.indvar.reduction_dim.14
...
fusion.loop_body.dim.0:                           ; preds = %fusion.loop_body.dim.0, %fusion.loop_body.dim.0.lr.ph
  ...
  %26 = getelementptr inbounds [1 x [64 x float]]* %fusion.1, i64 0, i64 0, i64 %fusion.indvar.dim.02
  %27 = load float* %26, align 4
  %28 = load float* %25, align 4
  %29 = fdiv float %27, %28
  %30 = getelementptr inbounds [64 x float]* %fusion, i64 0, i64 %fusion.indvar.dim.02
