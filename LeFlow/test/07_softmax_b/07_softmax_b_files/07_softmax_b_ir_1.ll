...
reduce.inner.loop_body.reduction_dim.1:           ; preds = %reduce.inner.loop_header.reduction_dim.1
  %7 = getelementptr inbounds [1 x [64 x float]], [1 x [64 x float]]* %bitcast, i64 0, i64 0, i64 %reduce.inner.indvar.reduction_dim.1
...
fusion.1.loop_body.dim.1:                         ; preds = %fusion.1.loop_header.dim.1
  %17 = getelementptr inbounds [1 x [64 x float]], [1 x [64 x float]]* %bitcast, i64 0, i64 0, i64 %fusion.1.indvar.dim.1
  ...
  %23 = getelementptr inbounds [1 x [64 x float]], [1 x [64 x float]]* %fusion.1, i64 0, i64 0, i64 %fusion.1.indvar.dim.1
...
fusion.1.loop_exit.dim.0:                         ; preds = %fusion.1.loop_header.dim.0
  ...
  %26 = getelementptr inbounds i8, i8* %25, i64 256
...
reduce.1.inner.loop_body.reduction_dim.1:         ; preds = %reduce.1.inner.loop_header.reduction_dim.1
  %30 = getelementptr inbounds [1 x [64 x float]], [1 x [64 x float]]* %fusion.1, i64 0, i64 0, i64 %reduce.1.inner.indvar.reduction_dim.1
...
fusion.loop_body.dim.0:                           ; preds = %fusion.loop_header.dim.0
  ...
  %41 = udiv i64 %40, 64
  %42 = getelementptr inbounds [1 x [64 x float]], [1 x [64 x float]]* %fusion.1, i64 0, i64 0, i64 %40
  %43 = load float, float* %42
  %44 = getelementptr inbounds [1 x float], [1 x float]* %reduce.1, i64 0, i64 0
  %45 = load float, float* %44
  %46 = fdiv float %43, %45
  %47 = getelementptr inbounds [64 x float], [64 x float]* %fusion, i64 0, i64 %fusion.indvar.dim.0
