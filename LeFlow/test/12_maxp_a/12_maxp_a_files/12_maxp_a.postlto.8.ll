; ModuleID = '12_maxp_a.postlto.8.bc'
...
reduce-window.inner.loop_exit.window.3.us:        ; preds = %reduce-window.inner.loop_exit.window.3.us, %reduce-window.inner.loop_body.window.3.lr.ph.us.preheader
  ...
  %6 = getelementptr inbounds [1 x [8 x [8 x [1 x float]]]]* @param0, i64 0, i64 0, i64 %3, i64 %5, i64 0
  ...
  br i1 %exitcond, label %reduce-window.inner.loop_exit.window.2, label %reduce-window.inner.loop_exit.window.3.us, !llvm.loop !1

reduce-window.inner.loop_exit.window.2:           ; preds = %reduce-window.inner.loop_exit.window.3.us
  %.lcssa = phi float [ %11, %reduce-window.inner.loop_exit.window.3.us ]
  %invar.inc5 = add nuw nsw i64 %reduce-window.inner.indvar.window.119, 1
  %exitcond6 = icmp eq i64 %invar.inc5, 3
  br i1 %exitcond6, label %reduce-window.loop_exit.dim.3, label %reduce-window.inner.loop_body.window.3.lr.ph.us.preheader, !llvm.loop !3
...
reduce-window.loop_exit.dim.3:                    ; preds = %reduce-window.inner.loop_exit.window.2
  ...
  %12 = getelementptr inbounds [1 x [2 x [2 x [1 x float]]]]* @temp0, i64 0, i64 0, i64 %reduce-window.indvar.dim.130, i64 %reduce-window.indvar.dim.227, i64 0
  store volatile float %.lcssa.lcssa, float* %12, align 4
  %invar.inc2 = add nuw nsw i64 %reduce-window.indvar.dim.227, 1
  %13 = icmp eq i64 %reduce-window.indvar.dim.227, 0
  br i1 %13, label %reduce-window.inner.loop_body.window.1.lr.ph, label %reduce-window.loop_exit.dim.2, !llvm.loop !4
...
reduce-window.loop_exit.dim.2:                    ; preds = %reduce-window.loop_exit.dim.3
  ...
  %14 = icmp eq i64 %reduce-window.indvar.dim.130, 0
  br i1 %14, label %reduce-window.loop_body.dim.2.lr.ph, label %reduce-window.loop_exit.dim.0, !llvm.loop !5

reduce-window.loop_exit.dim.0:                    ; preds = %reduce-window.loop_exit.dim.2
  %leflow_retval = load volatile float* getelementptr inbounds ([1 x [2 x [2 x [1 x float]]]]* @temp0, i64 0, i64 0, i64 0, i64 0, i64 0), align 4
