...
reduce-window.inner.loop_body.window.3.lr.ph.us.preheader: ; preds = %reduce-window.inner.loop_exit.window.2, %reduce-window.inner.loop_body.window.1.lr.ph
  %4 = phi float [ 0xFFF0000000000000, %reduce-window.inner.loop_body.window.1.lr.ph ], [ %.lcssa, %reduce-window.inner.loop_exit.window.2 ]
...
reduce-window.inner.loop_exit.window.2:           ; preds = %reduce-window.inner.loop_exit.window.3.us
  %.lcssa = phi float [ %12, %reduce-window.inner.loop_exit.window.3.us ]
...
reduce-window.loop_exit.dim.3:                    ; preds = %reduce-window.inner.loop_exit.window.2
  ...
  %exitcond3 = icmp ne i64 %invar.inc2, 2
  br i1 %exitcond3, label %reduce-window.inner.loop_body.window.1.lr.ph, label %reduce-window.loop_exit.dim.2, !llvm.loop !4

reduce-window.loop_exit.dim.2:                    ; preds = %reduce-window.loop_exit.dim.3
  %invar.inc1 = add nuw nsw i64 %0, 1
  %exitcond6 = icmp ne i64 %invar.inc1, 2
  br i1 %exitcond6, label %reduce-window.loop_body.dim.2.lr.ph, label %reduce-window.loop_exit.dim.0, !llvm.loop !5
