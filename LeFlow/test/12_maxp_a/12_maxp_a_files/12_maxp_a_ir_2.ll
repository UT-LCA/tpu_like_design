...
entry:
  ...
  %1 = bitcast i8* %arg0.untyped to [1 x [8 x [8 x [1 x float]]]]*
  %2 = getelementptr inbounds i8** %temps, i64 1
  %3 = load i8** %2, !dereferenceable !3, !align !2
  %reduce-window = bitcast i8* %3 to [1 x [2 x [2 x [1 x float]]]]*
...
reduce-window.loop_header.dim.0:                  ; preds = %reduce-window.loop_exit.dim.1, %entry
  %reduce-window.indvar.dim.0 = load i64* %reduce-window.invar_address.dim.0
...
reduce-window.loop_header.dim.1:                  ; preds = %reduce-window.loop_exit.dim.2, %reduce-window.loop_body.dim.0
  %reduce-window.indvar.dim.1 = load i64* %reduce-window.invar_address.dim.1
  %5 = icmp uge i64 %reduce-window.indvar.dim.1, 2
...
reduce-window.loop_header.dim.2:                  ; preds = %reduce-window.loop_exit.dim.3, %reduce-window.loop_body.dim.1
  %reduce-window.indvar.dim.2 = load i64* %reduce-window.invar_address.dim.2
  %6 = icmp uge i64 %reduce-window.indvar.dim.2, 2
...
reduce-window.loop_header.dim.3:                  ; preds = %reduce-window.inner.loop_exit.window.0, %reduce-window.loop_body.dim.2
  %reduce-window.indvar.dim.3 = load i64* %reduce-window.invar_address.dim.3
...
reduce-window.inner.loop_header.window.0:         ; preds = %reduce-window.inner.loop_exit.window.1, %reduce-window.loop_body.dim.3
  %reduce-window.inner.indvar.window.0 = load i64* %reduce-window.inner.invar_address.window.0
...
reduce-window.inner.loop_header.window.1:         ; preds = %reduce-window.inner.loop_exit.window.2, %reduce-window.inner.loop_body.window.0
  %reduce-window.inner.indvar.window.1 = load i64* %reduce-window.inner.invar_address.window.1
...
reduce-window.inner.loop_header.window.2:         ; preds = %reduce-window.inner.loop_exit.window.3, %reduce-window.inner.loop_body.window.1
  %reduce-window.inner.indvar.window.2 = load i64* %reduce-window.inner.invar_address.window.2
...
reduce-window.inner.loop_header.window.3:         ; preds = %in-bounds-after, %reduce-window.inner.loop_body.window.2
  %reduce-window.inner.indvar.window.3 = load i64* %reduce-window.inner.invar_address.window.3
...
in-bounds-after:                                  ; preds = %in-bounds-false, %in-bounds-true
  ...
  br label %reduce-window.inner.loop_header.window.3, !llvm.loop !4
...
reduce-window.inner.loop_exit.window.3:           ; preds = %reduce-window.inner.loop_header.window.3
  ...
  br label %reduce-window.inner.loop_header.window.2, !llvm.loop !6
...
reduce-window.inner.loop_exit.window.2:           ; preds = %reduce-window.inner.loop_header.window.2
  ...
  br label %reduce-window.inner.loop_header.window.1, !llvm.loop !7
...
reduce-window.inner.loop_exit.window.1:           ; preds = %reduce-window.inner.loop_header.window.1
  ...
  br label %reduce-window.inner.loop_header.window.0, !llvm.loop !8

reduce-window.inner.loop_exit.window.0:           ; preds = %reduce-window.inner.loop_header.window.0
  %32 = load float* %reduce_window_accumulator_address
  %33 = getelementptr inbounds [1 x [2 x [2 x [1 x float]]]]* %reduce-window, i64 0, i64 0, i64 %reduce-window.indvar.dim.1, i64 %reduce-window.indvar.dim.2, i64 0
  ...
  br label %reduce-window.loop_header.dim.3, !llvm.loop !9
...
reduce-window.loop_exit.dim.3:                    ; preds = %reduce-window.loop_header.dim.3
  ...
  br label %reduce-window.loop_header.dim.2, !llvm.loop !10
...
reduce-window.loop_exit.dim.2:                    ; preds = %reduce-window.loop_header.dim.2
  ...
  br label %reduce-window.loop_header.dim.1, !llvm.loop !11
...
reduce-window.loop_exit.dim.1:                    ; preds = %reduce-window.loop_header.dim.1
  ...
  br label %reduce-window.loop_header.dim.0, !llvm.loop !12

reduce-window.loop_exit.dim.0:                    ; preds = %reduce-window.loop_header.dim.0
  %tuple.1 = bitcast i8* %retval to [1 x i8*]*
  %34 = getelementptr inbounds [1 x i8*]* %tuple.1, i64 0, i64 0
  %35 = bitcast [1 x [2 x [2 x [1 x float]]]]* %reduce-window to i8*
  store i8* %35, i8** %34
  ret void

in-bounds-true:                                   ; preds = %reduce-window.inner.loop_body.window.3
  %36 = getelementptr inbounds [1 x [8 x [8 x [1 x float]]]]* %1, i64 0, i64 0, i64 %19, i64 %24, i64 0
...
!9 = metadata !{metadata !9, metadata !5}
!10 = metadata !{metadata !10, metadata !5}
!11 = metadata !{metadata !11, metadata !5}
!12 = metadata !{metadata !12, metadata !5}
