...
reduce-window.loop_exit.dim.3:                    ; preds = %reduce-window.inner.loop_exit.window.2
  ...
  br i1 %13, label %reduce-window.inner.loop_body.window.1.lr.ph, label %reduce-window.loop_exit.dim.2, !llvm.loop !3
...
reduce-window.loop_exit.dim.2:                    ; preds = %reduce-window.loop_exit.dim.3
  ...
  br i1 %14, label %reduce-window.loop_body.dim.2.lr.ph, label %reduce-window.loop_exit.dim.0, !llvm.loop !4
