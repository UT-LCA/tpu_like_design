; ModuleID = '14_maxp_b_f_files/14_maxp_b_f_ir_3.bc'
...
reduce-window.inner.loop_body.window.2.lr.ph:     ; preds = %reduce-window.inner.loop_exit.window.2, %reduce-window.inner.loop_body.window.1.lr.ph
  ...
  %7 = icmp ult i64 %6, 32
  br i1 %7, label %reduce-window.inner.loop_body.window.3.lr.ph.us.preheader, label %reduce-window.inner.loop_exit.window.3.preheader
...
reduce-window.inner.loop_exit.window.3.us:        ; preds = %reduce-window.inner.loop_header.window.3.reduce-window.inner.loop_exit.window.3_crit_edge.us-lcssa.us.us, %reduce-window.inner.loop_header.window.3.reduce-window.inner.loop_exit.window.3_crit_edge.us-lcssa.us17
  %8 = phi float [ %21, %reduce-window.inner.loop_header.window.3.reduce-window.inner.loop_exit.window.3_crit_edge.us-lcssa.us.us ], [ %11, %reduce-window.inner.loop_header.window.3.reduce-window.inner.loop_exit.window.3_crit_edge.us-lcssa.us17 ]
  %9 = phi float [ %21, %reduce-window.inner.loop_header.window.3.reduce-window.inner.loop_exit.window.3_crit_edge.us-lcssa.us.us ], [ %12, %reduce-window.inner.loop_header.window.3.reduce-window.inner.loop_exit.window.3_crit_edge.us-lcssa.us17 ]
  %invar.inc6.us = add nuw nsw i64 %reduce-window.inner.indvar.window.24.us, 1
  %10 = icmp ugt i64 %invar.inc6.us, 2
  br i1 %10, label %reduce-window.inner.loop_exit.window.2.loopexit, label %reduce-window.inner.loop_body.window.3.lr.ph.us, !llvm.loop !4
...
reduce-window.inner.loop_body.window.3.lr.ph.us:  ; preds = %reduce-window.inner.loop_exit.window.3.us, %reduce-window.inner.loop_body.window.3.lr.ph.us.preheader
  %11 = phi float [ %8, %reduce-window.inner.loop_exit.window.3.us ], [ %3, %reduce-window.inner.loop_body.window.3.lr.ph.us.preheader ]
  %12 = phi float [ %9, %reduce-window.inner.loop_exit.window.3.us ], [ %4, %reduce-window.inner.loop_body.window.3.lr.ph.us.preheader ]
  ...
  br i1 %15, label %reduce-window.inner.loop_header.window.3.reduce-window.inner.loop_exit.window.3_crit_edge.us-lcssa.us.us, label %reduce-window.inner.loop_header.window.3.reduce-window.inner.loop_exit.window.3_crit_edge.us-lcssa.us17

reduce-window.inner.loop_header.window.3.reduce-window.inner.loop_exit.window.3_crit_edge.us-lcssa.us17: ; preds = %reduce-window.inner.loop_body.window.3.lr.ph.us
...
reduce-window.inner.loop_header.window.3.reduce-window.inner.loop_exit.window.3_crit_edge.us-lcssa.us.us: ; preds = %reduce-window.inner.loop_body.window.3.lr.ph.us
  %16 = getelementptr inbounds [1 x [32 x [32 x [1 x float]]]]* %0, i64 0, i64 0, i64 %6, i64 %14, i64 0
...
reduce-window.inner.loop_exit.window.3:           ; preds = %reduce-window.inner.loop_exit.window.3, %reduce-window.inner.loop_exit.window.3.preheader
  ...
  br i1 %22, label %reduce-window.inner.loop_exit.window.2.loopexit34, label %reduce-window.inner.loop_exit.window.3, !llvm.loop !4
...
reduce-window.inner.loop_exit.window.2.loopexit34: ; preds = %reduce-window.inner.loop_exit.window.3
  br label %reduce-window.inner.loop_exit.window.2

reduce-window.inner.loop_exit.window.2:           ; preds = %reduce-window.inner.loop_exit.window.2.loopexit34, %reduce-window.inner.loop_exit.window.2.loopexit
  %23 = phi float [ %8, %reduce-window.inner.loop_exit.window.2.loopexit ], [ %3, %reduce-window.inner.loop_exit.window.2.loopexit34 ]
  %24 = phi float [ %9, %reduce-window.inner.loop_exit.window.2.loopexit ], [ %4, %reduce-window.inner.loop_exit.window.2.loopexit34 ]
  %invar.inc5 = add nuw nsw i64 %reduce-window.inner.indvar.window.119, 1
  %25 = icmp ugt i64 %invar.inc5, 2
  br i1 %25, label %reduce-window.loop_exit.dim.3, label %reduce-window.inner.loop_body.window.2.lr.ph, !llvm.loop !6

reduce-window.loop_exit.dim.3:                    ; preds = %reduce-window.inner.loop_exit.window.2
  %26 = getelementptr inbounds [1 x [10 x [10 x [1 x float]]]]* %reduce-window, i64 0, i64 0, i64 %reduce-window.indvar.dim.130, i64 %reduce-window.indvar.dim.227, i64 0
  store float %24, float* %26, align 4
  %invar.inc2 = add nuw nsw i64 %reduce-window.indvar.dim.227, 1
  %27 = icmp ugt i64 %invar.inc2, 9
  br i1 %27, label %reduce-window.loop_exit.dim.2, label %reduce-window.inner.loop_body.window.1.lr.ph, !llvm.loop !7
...
reduce-window.loop_exit.dim.2:                    ; preds = %reduce-window.loop_exit.dim.3
  ...
  br i1 %28, label %reduce-window.loop_exit.dim.0, label %reduce-window.loop_body.dim.2.lr.ph, !llvm.loop !8
