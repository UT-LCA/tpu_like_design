...
entry:
  ...
  %3 = load i8*, i8** %2, !dereferenceable !0, !align !1
...
fusion.loop_body.dim.0:                           ; preds = %fusion.loop_header.dim.0
  ...
  %7 = getelementptr inbounds [8 x float], [8 x float]* %1, i64 0, i64 %fusion.indvar.dim.0
  ...
  %17 = fmul float %5, %16
  %18 = fadd float %5, %17
  %19 = getelementptr inbounds [8 x float], [8 x float]* %fusion, i64 0, i64 %fusion.indvar.dim.0
...
fusion.loop_exit.dim.0:                           ; preds = %fusion.loop_header.dim.0
  ...
  %20 = getelementptr inbounds [1 x i8*], [1 x i8*]* %tuple.1, i64 0, i64 0
