; ModuleID = '15_thxprlsg_files/15_thxprlsg_ir_4.bc'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux_gnu"

define void @cluster_0__XlaCompiledKernel_true__XlaNumConstantArgs_0__XlaNumResourceArgs_0_.v13(i8* nocapture align 8 dereferenceable(8) %retval, i8* noalias nocapture readnone %run_options, i8** noalias nocapture readonly %params, i8** noalias nocapture readonly %temps, i64* noalias nocapture readnone %prof_counters) #0 {
fusion.loop_body.dim.0.lr.ph:
  ...
  %1 = load i8** %temps, align 8, !dereferenceable !0, !align !1
...
fusion.loop_body.dim.0:                           ; preds = %fusion.loop_body.dim.0, %fusion.loop_body.dim.0.lr.ph
  ...
  %2 = getelementptr inbounds [8 x float]* %0, i64 0, i64 %fusion.indvar.dim.02
  ...
  %11 = getelementptr inbounds [8 x float]* %fusion, i64 0, i64 %fusion.indvar.dim.02
  store float %10, float* %11, align 4
  %invar.inc = add nuw nsw i64 %fusion.indvar.dim.02, 1
  %12 = icmp ugt i64 %invar.inc, 7
  br i1 %12, label %fusion.loop_exit.dim.0, label %fusion.loop_body.dim.0, !llvm.loop !2
