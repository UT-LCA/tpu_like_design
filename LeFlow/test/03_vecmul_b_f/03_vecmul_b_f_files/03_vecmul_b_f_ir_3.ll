; ModuleID = '03_vecmul_b_f_files/03_vecmul_b_f_ir_3.bc'
...
multiply.loop_body.dim.0:                         ; preds = %multiply.loop_body.dim.0, %multiply.loop_body.dim.0.lr.ph
  ...
  %4 = getelementptr inbounds [64 x float]* %2, i64 0, i64 %multiply.indvar.dim.02
  %5 = load float* %4, align 4
  %6 = getelementptr inbounds [64 x float]* %1, i64 0, i64 %multiply.indvar.dim.02
  %7 = load float* %6, align 4
  %8 = fmul float %5, %7
  %9 = getelementptr inbounds [64 x float]* %multiply, i64 0, i64 %multiply.indvar.dim.02
  store float %8, float* %9, align 4
  %invar.inc = add nuw nsw i64 %multiply.indvar.dim.02, 1
  %10 = icmp ugt i64 %invar.inc, 63
  br i1 %10, label %multiply.loop_exit.dim.0, label %multiply.loop_body.dim.0, !llvm.loop !2
