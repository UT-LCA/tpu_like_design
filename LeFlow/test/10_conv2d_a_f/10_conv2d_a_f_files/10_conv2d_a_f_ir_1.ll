...
convolution.inner.loop_exit.k0:                   ; preds = %convolution.inner.loop_header.k0
  ...
  %34 = getelementptr inbounds [1 x [8 x [8 x [2 x float]]]], [1 x [8 x [8 x [2 x float]]]]* %convolution, i64 0, i64 0, i64 %convolution.indvar.dim.1, i64 %convolution.indvar.dim.2, i64 %convolution.indvar.dim.3
...
in-bounds-true:                                   ; preds = %convolution.inner.loop_body.iz
  ...
  %39 = getelementptr inbounds [1 x [8 x [8 x [1 x float]]]], [1 x [8 x [8 x [1 x float]]]]* %1, i64 0, i64 0, i64 %31, i64 %32, i64 0
