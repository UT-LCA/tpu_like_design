...
multiply.loop_body.dim.0:                         ; preds = %multiply.loop_body.dim.0, %multiply.loop_body.dim.0.lr.ph
  ...
  %scevgep = getelementptr [64 x float]* @temp0, i64 0, i64 %multiply.indvar.dim.02
  %scevgep2 = getelementptr [64 x float]* @param0, i64 0, i64 %multiply.indvar.dim.02
  %scevgep3 = getelementptr [64 x float]* @param1, i64 0, i64 %multiply.indvar.dim.02
