...
entry:
  ...
  %3 = load i8** %2, !dereferenceable !3, !align !4
...
reduce-window.inner.loop_exit.window.0:           ; preds = %reduce-window.inner.loop_header.window.0
  ...
  %33 = getelementptr inbounds [1 x [10 x [10 x [1 x float]]]]* %reduce-window, i64 0, i64 0, i64 %reduce-window.indvar.dim.1, i64 %reduce-window.indvar.dim.2, i64 0
...
in-bounds-true:                                   ; preds = %reduce-window.inner.loop_body.window.3
  %36 = getelementptr inbounds [1 x [32 x [32 x [1 x float]]]]* %1, i64 0, i64 0, i64 %19, i64 %24, i64 0
