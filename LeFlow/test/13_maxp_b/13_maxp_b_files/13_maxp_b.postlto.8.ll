; ModuleID = '13_maxp_b.postlto.8.bc'
...
reduce-window.loop_exit.dim.3:                    ; preds = %reduce-window.inner.loop_exit.window.2
  ...
  br i1 %exitcond7, label %reduce-window.loop_exit.dim.2, label %reduce-window.inner.loop_body.window.1.lr.ph, !llvm.loop !4
...
reduce-window.loop_exit.dim.2:                    ; preds = %reduce-window.loop_exit.dim.3
  ...
  br i1 %exitcond8, label %reduce-window.loop_exit.dim.0, label %reduce-window.loop_body.dim.2.lr.ph, !llvm.loop !5
