...
multiply.loop_body.dim.0:                         ; preds = %multiply.loop_header.dim.0
  %7 = getelementptr inbounds [8 x float], [8 x float]* %3, i64 0, i64 %multiply.indvar.dim.0
  %8 = load float, float* %7
  %9 = getelementptr inbounds [8 x float], [8 x float]* %1, i64 0, i64 %multiply.indvar.dim.0
  %10 = load float, float* %9
  %11 = fmul float %8, %10
  %12 = getelementptr inbounds [8 x float], [8 x float]* %multiply, i64 0, i64 %multiply.indvar.dim.0
