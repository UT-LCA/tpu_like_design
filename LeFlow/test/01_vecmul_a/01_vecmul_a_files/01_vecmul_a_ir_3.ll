; ModuleID = '01_vecmul_a_files/01_vecmul_a_ir_3.bc'
...
multiply.loop_body.dim.0:                         ; preds = %multiply.loop_body.dim.0, %multiply.loop_body.dim.0.lr.ph
  ...
  %4 = getelementptr inbounds [8 x float]* %2, i64 0, i64 %multiply.indvar.dim.02
  %5 = load float* %4, align 4
  %6 = getelementptr inbounds [8 x float]* %1, i64 0, i64 %multiply.indvar.dim.02
  %7 = load float* %6, align 4
  %8 = fmul float %5, %7
  %9 = getelementptr inbounds [8 x float]* %multiply, i64 0, i64 %multiply.indvar.dim.02
