...
entry:
  ...
  %arg0.untyped = load i8** %2, !dereferenceable !0, !align !1
  %3 = bitcast i8* %arg0.untyped to [8 x float]*
  %4 = getelementptr inbounds i8** %temps, i64 0
  %5 = load i8** %4, !dereferenceable !0, !align !1
  %multiply = bitcast i8* %5 to [8 x float]*
...
multiply.loop_header.dim.0:                       ; preds = %multiply.loop_body.dim.0, %entry
  %multiply.indvar.dim.0 = load i64* %multiply.invar_address.dim.0
  %6 = icmp uge i64 %multiply.indvar.dim.0, 8
...
multiply.loop_body.dim.0:                         ; preds = %multiply.loop_header.dim.0
  %7 = getelementptr inbounds [8 x float]* %3, i64 0, i64 %multiply.indvar.dim.0
  %8 = load float* %7
  %9 = getelementptr inbounds [8 x float]* %1, i64 0, i64 %multiply.indvar.dim.0
  %10 = load float* %9
  %11 = fmul float %8, %10
  %12 = getelementptr inbounds [8 x float]* %multiply, i64 0, i64 %multiply.indvar.dim.0
...
multiply.loop_exit.dim.0:                         ; preds = %multiply.loop_header.dim.0
  ...
  %13 = getelementptr inbounds [1 x i8*]* %tuple.1, i64 0, i64 0
  %14 = bitcast [8 x float]* %multiply to i8*
  store i8* %14, i8** %13
  ret void
}
