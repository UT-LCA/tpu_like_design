...
convolution.inner.loop_body.k0.lr.ph:             ; preds = %convolution.inner.loop_exit.k0, %convolution.loop_body.dim.3.lr.ph
  ...
  %scevgep8 = getelementptr [1 x [64 x [64 x [2 x float]]]]* @temp0, i64 0, i64 0, i64 %convolution.indvar.dim.126, i64 %convolution.indvar.dim.223, i64 %3
...
convolution.inner.loop_body.iz.lr.ph.us:          ; preds = %convolution.inner.loop_exit.iz.us, %convolution.inner.loop_body.iz.lr.ph.us.preheader
  ...
  br i1 %14, label %convolution.inner.loop_header.iz.convolution.inner.loop_exit.iz_crit_edge.us-lcssa.us.us, label %convolution.inner.loop_exit.iz.us
...
convolution.inner.loop_header.iz.convolution.inner.loop_exit.iz_crit_edge.us-lcssa.us.us: ; preds = %convolution.inner.loop_body.iz.lr.ph.us
  ...
  %scevgep3 = getelementptr [1 x [64 x [64 x [1 x float]]]]* @param0, i64 0, i64 0, i64 %6, i64 %15, i64 0
...
convolution.inner.loop_exit.k0:                   ; preds = %convolution.inner.loop_exit.k1
  ...
  br i1 %exitcond6, label %convolution.loop_exit.dim.3, label %convolution.inner.loop_body.k0.lr.ph, !llvm.loop !4

convolution.loop_exit.dim.3:                      ; preds = %convolution.inner.loop_exit.k0
  %23 = add nuw nsw i64 %convolution.indvar.dim.223, 1
  %exitcond9 = icmp eq i64 %23, 64
...
convolution.loop_exit.dim.0:                      ; preds = %convolution.loop_exit.dim.2
  %leflow_retval = load volatile float* getelementptr inbounds ([1 x [64 x [64 x [2 x float]]]]* @temp0, i64 0, i64 0, i64 0, i64 0, i64 0), align 8
