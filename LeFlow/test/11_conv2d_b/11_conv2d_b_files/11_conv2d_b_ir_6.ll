; ModuleID = '11_conv2d_b_files/11_conv2d_b_ir_4.bc'
...
convolution.inner.loop_exit.iz.us:                ; preds = %convolution.inner.loop_header.iz.convolution.inner.loop_exit.iz_crit_edge.us-lcssa.us.us, %convolution.inner.loop_body.iz.lr.ph.us
  ...
  br i1 %8, label %convolution.inner.loop_exit.k1, label %convolution.inner.loop_body.iz.lr.ph.us, !llvm.loop !5
...
convolution.inner.loop_exit.iz:                   ; preds = %convolution.inner.loop_exit.iz, %convolution.inner.loop_body.k1.lr.ph
  ...
  br i1 %19, label %convolution.inner.loop_exit.k1, label %convolution.inner.loop_exit.iz, !llvm.loop !5
...
convolution.inner.loop_exit.k1:                   ; preds = %convolution.inner.loop_exit.iz, %convolution.inner.loop_exit.iz.us
  ...
  br i1 %22, label %convolution.inner.loop_exit.k0, label %convolution.inner.loop_body.k1.lr.ph, !llvm.loop !7
...
convolution.inner.loop_exit.k0:                   ; preds = %convolution.inner.loop_exit.k1
  ...
  br i1 %24, label %convolution.inner.loop_body.k0.lr.ph, label %convolution.loop_exit.dim.3, !llvm.loop !8
...
convolution.loop_exit.dim.3:                      ; preds = %convolution.inner.loop_exit.k0
  ...
  br i1 %25, label %convolution.loop_exit.dim.2, label %convolution.loop_body.dim.3.lr.ph, !llvm.loop !9
...
convolution.loop_exit.dim.2:                      ; preds = %convolution.loop_exit.dim.3
  ...
  br i1 %26, label %convolution.loop_exit.dim.0, label %convolution.loop_body.dim.2.lr.ph, !llvm.loop !10
