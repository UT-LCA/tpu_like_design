; ModuleID = '11_conv2d_b.prelto.linked.bc'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux_gnu"

@temp0 = global [1 x [64 x [64 x [2 x float]]]] zeroinitializer, align 8
@param1 = global [3 x [3 x [1 x [2 x float]]]] zeroinitializer, align 8
@param0 = global [1 x [64 x [64 x [1 x float]]]] zeroinitializer, align 8
...
convolution.inner.loop_body.k1.lr.ph:             ; preds = %convolution.inner.loop_exit.k1, %convolution.inner.loop_body.k0.lr.ph
  ...
  br i1 %4, label %convolution.inner.loop_body.iz.lr.ph.us.preheader, label %convolution.inner.loop_exit.iz.preheader
...
convolution.inner.loop_exit.iz.us:                ; preds = %convolution.inner.loop_header.iz.convolution.inner.loop_exit.iz_crit_edge.us-lcssa.us.us, %convolution.inner.loop_body.iz.lr.ph.us
  ...
  br i1 %8, label %convolution.inner.loop_exit.k1.loopexit, label %convolution.inner.loop_body.iz.lr.ph.us, !llvm.loop !0
...
convolution.inner.loop_body.iz.lr.ph.us:          ; preds = %convolution.inner.loop_exit.iz.us, %convolution.inner.loop_body.iz.lr.ph.us.preheader
  %9 = phi float [ %6, %convolution.inner.loop_exit.iz.us ], [ %0, %convolution.inner.loop_body.iz.lr.ph.us.preheader ]
  %10 = phi float [ %7, %convolution.inner.loop_exit.iz.us ], [ %1, %convolution.inner.loop_body.iz.lr.ph.us.preheader ]
...
convolution.inner.loop_header.iz.convolution.inner.loop_exit.iz_crit_edge.us-lcssa.us.us: ; preds = %convolution.inner.loop_body.iz.lr.ph.us
  ...
  %15 = getelementptr inbounds [1 x [64 x [64 x [1 x float]]]]* @param0, i64 0, i64 0, i64 %3, i64 %11, i64 0
...
convolution.inner.loop_exit.iz:                   ; preds = %convolution.inner.loop_exit.iz, %convolution.inner.loop_exit.iz.preheader
  ...
  br i1 %19, label %convolution.inner.loop_exit.k1.loopexit1, label %convolution.inner.loop_exit.iz, !llvm.loop !0

convolution.inner.loop_exit.k1.loopexit:          ; preds = %convolution.inner.loop_exit.iz.us
  br label %convolution.inner.loop_exit.k1

convolution.inner.loop_exit.k1.loopexit1:         ; preds = %convolution.inner.loop_exit.iz
  br label %convolution.inner.loop_exit.k1

convolution.inner.loop_exit.k1:                   ; preds = %convolution.inner.loop_exit.k1.loopexit1, %convolution.inner.loop_exit.k1.loopexit
  %20 = phi float [ %6, %convolution.inner.loop_exit.k1.loopexit ], [ %0, %convolution.inner.loop_exit.k1.loopexit1 ]
  %21 = phi float [ %7, %convolution.inner.loop_exit.k1.loopexit ], [ %1, %convolution.inner.loop_exit.k1.loopexit1 ]
...
convolution.inner.loop_exit.k0:                   ; preds = %convolution.inner.loop_exit.k1
  %23 = getelementptr inbounds [1 x [64 x [64 x [2 x float]]]]* @temp0, i64 0, i64 0, i64 %convolution.indvar.dim.126, i64 %convolution.indvar.dim.223, i64 %convolution.indvar.dim.320
...
convolution.loop_exit.dim.0:                      ; preds = %convolution.loop_exit.dim.2
  %leflow_gep = getelementptr inbounds [1 x [64 x [64 x [2 x float]]]]* @temp0, i64 0, i64 0, i64 0, i64 0, i64 0
