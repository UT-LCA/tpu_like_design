; ModuleID = '11_conv2d_b.prelto.6.bc'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux_gnu"

@temp0 = internal global [1 x [64 x [64 x [2 x float]]]] zeroinitializer, align 8
@param1 = internal global [3 x [3 x [1 x [2 x float]]]] zeroinitializer, align 8
@param0 = internal global [1 x [64 x [64 x [1 x float]]]] zeroinitializer, align 8
...
convolution.inner.loop_exit.iz.us:                ; preds = %convolution.inner.loop_header.iz.convolution.inner.loop_exit.iz_crit_edge.us-lcssa.us.us, %convolution.inner.loop_body.iz.lr.ph.us
  ...
  br i1 %exitcond, label %convolution.inner.loop_exit.k1, label %convolution.inner.loop_body.iz.lr.ph.us, !llvm.loop !0
...
convolution.inner.loop_header.iz.convolution.inner.loop_exit.iz_crit_edge.us-lcssa.us.us: ; preds = %convolution.inner.loop_body.iz.lr.ph.us
  ...
  %14 = getelementptr inbounds [1 x [64 x [64 x [1 x float]]]]* @param0, i64 0, i64 0, i64 %4, i64 %10, i64 0
...
convolution.inner.loop_exit.k1:                   ; preds = %convolution.inner.loop_exit.iz.us, %convolution.inner.loop_body.k1.lr.ph
  %18 = phi float [ %6, %convolution.inner.loop_exit.iz.us ], [ %2, %convolution.inner.loop_body.k1.lr.ph ]
  %19 = phi float [ %7, %convolution.inner.loop_exit.iz.us ], [ %3, %convolution.inner.loop_body.k1.lr.ph ]
  %invar.inc4 = add nuw nsw i64 %convolution.inner.indvar.k016, 1
  %exitcond6 = icmp eq i64 %invar.inc4, 3
  br i1 %exitcond6, label %convolution.inner.loop_exit.k0, label %convolution.inner.loop_body.k1.lr.ph, !llvm.loop !2

convolution.inner.loop_exit.k0:                   ; preds = %convolution.inner.loop_exit.k1
  %.lcssa5 = phi float [ %19, %convolution.inner.loop_exit.k1 ]
  %20 = getelementptr inbounds [1 x [64 x [64 x [2 x float]]]]* @temp0, i64 0, i64 0, i64 %convolution.indvar.dim.126, i64 %convolution.indvar.dim.223, i64 %convolution.indvar.dim.320
  store volatile float %.lcssa5, float* %20, align 4
  %invar.inc3 = add nuw nsw i64 %convolution.indvar.dim.320, 1
  %21 = icmp eq i64 %convolution.indvar.dim.320, 0
  br i1 %21, label %convolution.inner.loop_body.k0.lr.ph, label %convolution.loop_exit.dim.3, !llvm.loop !3

convolution.loop_exit.dim.3:                      ; preds = %convolution.inner.loop_exit.k0
  %invar.inc2 = add nuw nsw i64 %convolution.indvar.dim.223, 1
  %exitcond7 = icmp eq i64 %invar.inc2, 64
  br i1 %exitcond7, label %convolution.loop_exit.dim.2, label %convolution.loop_body.dim.3.lr.ph, !llvm.loop !4

convolution.loop_exit.dim.2:                      ; preds = %convolution.loop_exit.dim.3
  %invar.inc1 = add nuw nsw i64 %convolution.indvar.dim.126, 1
  %exitcond8 = icmp eq i64 %invar.inc1, 64
  br i1 %exitcond8, label %convolution.loop_exit.dim.0, label %convolution.loop_body.dim.2.lr.ph, !llvm.loop !5

convolution.loop_exit.dim.0:                      ; preds = %convolution.loop_exit.dim.2
  %leflow_retval = load volatile float* getelementptr inbounds ([1 x [64 x [64 x [2 x float]]]]* @temp0, i64 0, i64 0, i64 0, i64 0, i64 0), align 4
