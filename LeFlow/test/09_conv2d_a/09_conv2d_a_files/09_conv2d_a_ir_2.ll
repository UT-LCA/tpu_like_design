...
entry:
  ...
  %arg1.untyped = load i8** %2, !dereferenceable !2, !align !1
  %3 = bitcast i8* %arg1.untyped to [3 x [3 x [1 x [2 x float]]]]*
  %4 = getelementptr inbounds i8** %temps, i64 0
  %5 = load i8** %4, !dereferenceable !3, !align !4
  %convolution = bitcast i8* %5 to [1 x [8 x [8 x [2 x float]]]]*
...
convolution.loop_header.dim.1:                    ; preds = %convolution.loop_exit.dim.2, %convolution.loop_body.dim.0
  ...
  %7 = icmp uge i64 %convolution.indvar.dim.1, 8
...
convolution.loop_header.dim.2:                    ; preds = %convolution.loop_exit.dim.3, %convolution.loop_body.dim.1
  ...
  %8 = icmp uge i64 %convolution.indvar.dim.2, 8
...
convolution.inner.loop_exit.k0:                   ; preds = %convolution.inner.loop_header.k0
  %33 = load float* %convolution_sum_address
  %34 = getelementptr inbounds [1 x [8 x [8 x [2 x float]]]]* %convolution, i64 0, i64 0, i64 %convolution.indvar.dim.1, i64 %convolution.indvar.dim.2, i64 %convolution.indvar.dim.3
...
convolution.loop_exit.dim.0:                      ; preds = %convolution.loop_header.dim.0
  ...
  %35 = getelementptr inbounds [1 x i8*]* %tuple.1, i64 0, i64 0
  %36 = bitcast [1 x [8 x [8 x [2 x float]]]]* %convolution to i8*
  store i8* %36, i8** %35
  ret void

in-bounds-true:                                   ; preds = %convolution.inner.loop_body.iz
  %37 = getelementptr inbounds [3 x [3 x [1 x [2 x float]]]]* %3, i64 0, i64 %convolution.inner.indvar.k0, i64 %convolution.inner.indvar.k1, i64 0, i64 %convolution.indvar.dim.3
  %38 = load float* %37
  %39 = getelementptr inbounds [1 x [8 x [8 x [1 x float]]]]* %1, i64 0, i64 0, i64 %31, i64 %32, i64 0
  %40 = load float* %39
  %41 = fmul float %40, %38
  %42 = load float* %convolution_sum_address
  %43 = fadd float %42, %41
