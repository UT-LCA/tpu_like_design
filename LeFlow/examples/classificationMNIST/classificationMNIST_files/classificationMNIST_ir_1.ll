...
entry:
  ...
  %0 = getelementptr inbounds i8*, i8** %params, i64 1
  %arg1.untyped = load i8*, i8** %0, !dereferenceable !1, !align !2
  %1 = bitcast i8* %arg1.untyped to [10 x float]*
  %2 = getelementptr inbounds i8*, i8** %params, i64 0
  %arg0.untyped = load i8*, i8** %2, !dereferenceable !3, !align !4
  %3 = bitcast i8* %arg0.untyped to [784 x [10 x float]]*
  %4 = getelementptr inbounds i8*, i8** %params, i64 2
  %arg2.untyped = load i8*, i8** %4, !dereferenceable !5, !align !4
  %5 = bitcast i8* %arg2.untyped to [1 x [784 x float]]*
  %6 = getelementptr inbounds i8*, i8** %temps, i64 2
  %7 = load i8*, i8** %6, !dereferenceable !1, !align !2
...
dot.loop_body.reduction:                          ; preds = %dot.loop_header.reduction
  %11 = getelementptr inbounds [1 x [784 x float]], [1 x [784 x float]]* %5, i64 0, i64 0, i64 %dot.indvar.reduction
  %12 = load float, float* %11
  %13 = getelementptr inbounds [784 x [10 x float]], [784 x [10 x float]]* %3, i64 0, i64 %dot.indvar.reduction, i64 %dot.indvar.rhs.1
...
dot.loop_exit.reduction:                          ; preds = %dot.loop_header.reduction
  ...
  %19 = getelementptr inbounds [1 x [10 x float]], [1 x [10 x float]]* %dot, i64 0, i64 0, i64 %dot.indvar.rhs.1
...
dot.loop_exit.lhs.0:                              ; preds = %dot.loop_header.lhs.0
  %20 = getelementptr inbounds i8*, i8** %temps, i64 11
  %21 = load i8*, i8** %20, !dereferenceable !10, !align !2
...
fusion.2.loop_body.dim.1:                         ; preds = %fusion.2.loop_header.dim.1
  ...
  %31 = udiv i64 %30, 10
  %32 = getelementptr inbounds [1 x [10 x float]], [1 x [10 x float]]* %dot, i64 0, i64 0, i64 %30
  %33 = load float, float* %32
  %34 = getelementptr inbounds [10 x float], [10 x float]* %1, i64 0, i64 %25
  %35 = load float, float* %34
  %36 = fadd float %33, %35
  %37 = getelementptr inbounds [1 x [10 x float]], [1 x [10 x float]]* %fusion.2, i64 0, i64 0, i64 %fusion.2.indvar.dim.1
...
fusion.2.loop_exit.dim.0:                         ; preds = %fusion.2.loop_header.dim.0
  %38 = getelementptr inbounds i8*, i8** %temps, i64 11
  %39 = load i8*, i8** %38, !dereferenceable !10, !align !2
...
reduce.inner.loop_body.reduction_dim.1:           ; preds = %reduce.inner.loop_header.reduction_dim.1
  %44 = getelementptr inbounds [1 x [10 x float]], [1 x [10 x float]]* %fusion.2, i64 0, i64 0, i64 %reduce.inner.indvar.reduction_dim.1
  %reduce_function_parameter_0_address_as_i8ptr = bitcast float* %accumulator to i8*
  %45 = getelementptr inbounds i8*, i8** %reduce_function_parameter_addresses, i64 0
  ...
  %46 = getelementptr inbounds i8*, i8** %reduce_function_parameter_addresses, i64 1
...
reduce.inner.loop_exit.reduction_dim.1:           ; preds = %reduce.inner.loop_header.reduction_dim.1
  %48 = load float, float* %accumulator
  %49 = getelementptr inbounds [1 x float], [1 x float]* %reduce, i64 0, i64 0
...
reduce.loop_exit.dim.0:                           ; preds = %reduce.loop_header.dim.0
  %50 = getelementptr inbounds i8*, i8** %temps, i64 11
  %51 = load i8*, i8** %50, !dereferenceable !10, !align !2
...
fusion.1.loop_body.dim.1:                         ; preds = %fusion.1.loop_header.dim.1
  ...
  %61 = udiv i64 %60, 10
  %62 = getelementptr inbounds [1 x [10 x float]], [1 x [10 x float]]* %dot, i64 0, i64 0, i64 %60
  %63 = load float, float* %62
  %64 = getelementptr inbounds [10 x float], [10 x float]* %1, i64 0, i64 %55
  %65 = load float, float* %64
  %66 = fadd float %63, %65
  %67 = getelementptr inbounds [1 x float], [1 x float]* %reduce, i64 0, i64 0
  %68 = load float, float* %67
  %69 = fsub float %66, %68
  %70 = call float @llvm.exp.f32(float %69)
  %71 = getelementptr inbounds [1 x [10 x float]], [1 x [10 x float]]* %fusion.1, i64 0, i64 0, i64 %fusion.1.indvar.dim.1
...
fusion.1.loop_exit.dim.0:                         ; preds = %fusion.1.loop_header.dim.0
  %72 = getelementptr inbounds i8*, i8** %temps, i64 11
  %73 = load i8*, i8** %72, !dereferenceable !10, !align !2
...
reduce.1.inner.loop_body.reduction_dim.1:         ; preds = %reduce.1.inner.loop_header.reduction_dim.1
  %78 = getelementptr inbounds [1 x [10 x float]], [1 x [10 x float]]* %fusion.1, i64 0, i64 0, i64 %reduce.1.inner.indvar.reduction_dim.1
  %reduce_function_parameter_0_address_as_i8ptr14 = bitcast float* %accumulator10 to i8*
  %79 = getelementptr inbounds i8*, i8** %reduce_function_parameter_addresses13, i64 0
  ...
  %80 = getelementptr inbounds i8*, i8** %reduce_function_parameter_addresses13, i64 1
  ...
  %reduce_function_return_value16 = load float, float* %reduce_function_return_value_address12
...
reduce.1.inner.loop_exit.reduction_dim.1:         ; preds = %reduce.1.inner.loop_header.reduction_dim.1
  %82 = load float, float* %accumulator10
  %83 = getelementptr inbounds [1 x float], [1 x float]* %reduce.1, i64 0, i64 0
...
reduce.1.loop_exit.dim.0:                         ; preds = %reduce.1.loop_header.dim.0
  %84 = getelementptr inbounds i8*, i8** %temps, i64 2
  %85 = load i8*, i8** %84, !dereferenceable !1, !align !2
...
fusion.loop_body.dim.0:                           ; preds = %fusion.loop_header.dim.0
  ...
  %89 = udiv i64 %88, 10
  %90 = getelementptr inbounds [1 x [10 x float]], [1 x [10 x float]]* %fusion.1, i64 0, i64 0, i64 %88
  %91 = load float, float* %90
  %92 = getelementptr inbounds [1 x float], [1 x float]* %reduce.1, i64 0, i64 0
  %93 = load float, float* %92
  %94 = fdiv float %91, %93
  %95 = getelementptr inbounds [10 x float], [10 x float]* %fusion, i64 0, i64 %fusion.indvar.dim.0
...
fusion.loop_exit.dim.0:                           ; preds = %fusion.loop_header.dim.0
  ...
  %96 = getelementptr inbounds [1 x i8*], [1 x i8*]* %tuple.1, i64 0, i64 0
