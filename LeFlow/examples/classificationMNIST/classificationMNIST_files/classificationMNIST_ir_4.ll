...
fusion.1.loop_body.dim.1:                         ; preds = %fusion.1.loop_body.dim.1, %fusion.1.loop_body.dim.1.lr.ph
  ...
  %40 = fadd float %37, %39
  %41 = load float* %35, align 4
  %42 = fsub float %40, %41
  %43 = call float @llvm.exp.f32(float %42)
  %44 = getelementptr inbounds [1 x [10 x float]]* %fusion.2, i64 0, i64 0, i64 %fusion.1.indvar.dim.18
  store float %43, float* %44, align 4
  %invar.inc8 = add nuw nsw i64 %fusion.1.indvar.dim.18, 1
  %45 = icmp ugt i64 %invar.inc8, 9
  br i1 %45, label %reduce.1.inner.loop_body.reduction_dim.1, label %fusion.1.loop_body.dim.1, !llvm.loop !11

reduce.1.inner.loop_body.reduction_dim.1:         ; preds = %reduce.1.inner.loop_body.reduction_dim.1, %fusion.1.loop_body.dim.1
  %46 = phi float [ %49, %reduce.1.inner.loop_body.reduction_dim.1 ], [ 0.000000e+00, %fusion.1.loop_body.dim.1 ]
  ...
  %47 = getelementptr inbounds [1 x [10 x float]]* %fusion.2, i64 0, i64 0, i64 %reduce.1.inner.indvar.reduction_dim.14
  %48 = load float* %47, align 4
  %49 = fadd float %46, %48
  %invar.inc11 = add nuw nsw i64 %reduce.1.inner.indvar.reduction_dim.14, 1
  %50 = icmp ugt i64 %invar.inc11, 9
  br i1 %50, label %fusion.loop_body.dim.0.lr.ph, label %reduce.1.inner.loop_body.reduction_dim.1, !llvm.loop !12
...
fusion.loop_body.dim.0:                           ; preds = %fusion.loop_body.dim.0, %fusion.loop_body.dim.0.lr.ph
  ...
  %51 = getelementptr inbounds [1 x [10 x float]]* %fusion.2, i64 0, i64 0, i64 %fusion.indvar.dim.02
  %52 = load float* %51, align 4
  %53 = load float* %35, align 4
  %54 = fdiv float %52, %53
  %55 = getelementptr inbounds [10 x float]* %fusion, i64 0, i64 %fusion.indvar.dim.02
  store float %54, float* %55, align 4
  %invar.inc17 = add nuw nsw i64 %fusion.indvar.dim.02, 1
  %56 = icmp ugt i64 %invar.inc17, 9
  br i1 %56, label %fusion.loop_exit.dim.0, label %fusion.loop_body.dim.0, !llvm.loop !13

fusion.loop_exit.dim.0:                           ; preds = %fusion.loop_body.dim.0
  %57 = bitcast i8* %retval to i8**
